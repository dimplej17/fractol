...
static int	setup_mandelbrot(t_fractal *fractal)
{
...
static int	setup_julia_params(char *arg1, char *arg2, t_fractal *fractal)
{
	double	real;
	double	imag;
...
static int	setup_julia(char *argv[], int argc, t_fractal *fractal)
{
